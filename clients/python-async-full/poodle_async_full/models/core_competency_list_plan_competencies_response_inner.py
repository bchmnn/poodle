...
class CoreCompetencyListPlanCompetenciesResponseInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["competency", "usercompetency", "usercompetencyplan"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyListPlanCompetenciesResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyListPlanCompetenciesResponseInner from a dict"""
        if obj is None:
            return None
