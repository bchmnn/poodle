...
class ReportCompetencyDataForReportResponseUsercompetenciesInnerUsercompetencycourse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["competencyid", "courseid", "grade", "gradename", "id", "proficiency", "proficiencyname", "timecreated", "timemodified", "userid", "usermodified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportCompetencyDataForReportResponseUsercompetenciesInnerUsercompetencycourse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportCompetencyDataForReportResponseUsercompetenciesInnerUsercompetencycourse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ReportCompetencyDataForReportResponseUsercompetenciesInnerUsercompetencycourse" in settings.relaxed_models
