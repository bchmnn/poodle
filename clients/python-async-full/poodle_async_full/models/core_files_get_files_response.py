...
class CoreFilesGetFilesResponse(BaseModel):
    ...
    """ # noqa: E501
    files: List[CoreFilesGetFilesResponseFilesInner]
    parents: List[CoreFilesGetFilesResponseParentsInner]
    __properties: ClassVar[List[str]] = ["files", "parents"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreFilesGetFilesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreFilesGetFilesResponse from a dict"""
        if obj is None:
            return None
