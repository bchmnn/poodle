...
class CoreFilesGetUnusedDraftItemidResponse(BaseModel):
    """
    CoreFilesGetUnusedDraftItemidResponse
    """ # noqa: E501
    component: Optional[StrictStr] = Field(description="File area component.")
    contextid: Optional[StrictInt] = Field(description="File area context.")
    filearea: Optional[StrictStr] = Field(description="File area name.")
    itemid: Optional[StrictInt] = Field(description="File are item id.")
    userid: Optional[StrictInt] = Field(description="File area user id.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["component", "contextid", "filearea", "itemid", "userid", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreFilesGetUnusedDraftItemidResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreFilesGetUnusedDraftItemidResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreFilesGetUnusedDraftItemidResponse" in settings.relaxed_models
