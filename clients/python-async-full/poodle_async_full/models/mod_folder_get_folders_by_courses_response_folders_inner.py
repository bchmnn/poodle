...
class ModFolderGetFoldersByCoursesResponseFoldersInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "display", "enableaitools", "enabledaiactions", "forcedownload", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "revision", "section", "showdownloadfolder", "showexpanded", "timemodified", "visible"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        relaxed = settings.relaxe_all_models or "ModFolderGetFoldersByCoursesResponseFoldersInner" in settings.relaxed_models
