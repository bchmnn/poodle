...
class CoreCalendarGetTimestampsParametersDataInner(BaseModel):
    ...
    """ # noqa: E501
    day: Optional[StrictInt] = Field(description="day")
    hour: Optional[StrictInt] = Field(default=None, description="hour")
    key: Optional[StrictStr] = Field(default=None, description="key")
    minute: Optional[StrictInt] = Field(default=None, description="minute")
    month: Optional[StrictInt] = Field(description="month")
    year: Optional[StrictInt] = Field(description="year")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCalendarGetTimestampsParametersDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCalendarGetTimestampsParametersDataInner from a dict"""
        if obj is None:
            return None
