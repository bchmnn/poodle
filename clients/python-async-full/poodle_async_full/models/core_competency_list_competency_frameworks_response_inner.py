...
class CoreCompetencyListCompetencyFrameworksResponseInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCompetencyFrameworksResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCompetencyFrameworksResponseInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreCompetencyListCompetencyFrameworksResponseInner" in settings.relaxed_models
        ...
        data = {
            ...
            "competenciescount": obj.get("competenciescount") if obj.get("competenciescount") is not None else 0,
