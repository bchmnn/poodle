...
class ToolMobileCallExternalFunctionsResponse(BaseModel):
    ...
    """ # noqa: E501
    responses: List[ToolMobileCallExternalFunctionsResponseResponsesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolMobileCallExternalFunctionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolMobileCallExternalFunctionsResponse from a dict"""
        if obj is None:
            return None
