...
class ModWikiGetWikisByCoursesResponse(BaseModel):
    ...
    wikis: List[ModWikiGetWikisByCoursesResponseWikisInner]
    __properties: ClassVar[List[str]] = ["warnings", "wikis"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModWikiGetWikisByCoursesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.wikis:
            for _item_wikis in self.wikis:
                if _item_wikis:
                    _items.append(_item_wikis.to_dict())
            _dict['wikis'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModWikiGetWikisByCoursesResponse from a dict"""
        if obj is None:
            return None
