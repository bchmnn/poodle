...
class CoreCourseGetCourseContentItemsResponseContentItemsInner(BaseModel):
    ...
    gradable: StrictBool = Field(description="Whether this content item is gradable or not")
    ...
    otherpurpose: Optional[StrictStr] = Field(description="The alternative purpose of the component exposing the content item")
    ...
    __properties: ClassVar[List[str]] = ["archetype", "branded", "componentname", "favourite", "gradable", "help", "icon", "id", "legacyitem", "link", "name", "otherpurpose", "purpose", "recommended", "title"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if otherpurpose (nullable) is None
        # and model_fields_set contains the field
        if self.otherpurpose is None and "otherpurpose" in self.model_fields_set:
            _dict['otherpurpose'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        data = {
            ...
            "gradable": obj.get("gradable") if obj.get("gradable") is not None else False,
            ...
            "otherpurpose": obj.get("otherpurpose"),
