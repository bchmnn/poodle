...
class ModGlossaryGetEntriesByAuthorIdResponse(BaseModel):
    """
    ...
    entries: List[ModGlossaryGetEntriesByAuthorIdResponseEntriesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModGlossaryGetEntriesByAuthorIdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModGlossaryGetEntriesByAuthorIdResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModGlossaryGetEntriesByAuthorIdResponse" in settings.relaxed_models
        ...
        data = {
            "count": obj.get("count"),
            "entries": [ModGlossaryGetEntriesByAuthorIdResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
