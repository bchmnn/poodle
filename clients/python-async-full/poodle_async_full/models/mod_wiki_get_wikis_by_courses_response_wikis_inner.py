...
class ModWikiGetWikisByCoursesResponseWikisInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cancreatepages", "course", "coursemodule", "defaultformat", "editbegin", "editend", "enableaitools", "enabledaiactions", "firstpagetitle", "forceformat", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "section", "timecreated", "timemodified", "visible", "wikimode"]
