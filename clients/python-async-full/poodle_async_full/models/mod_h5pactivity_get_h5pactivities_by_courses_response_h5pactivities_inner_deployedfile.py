...
class ModH5pactivityGetH5pactivitiesByCoursesResponseH5pactivitiesInnerDeployedfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filename", "filepath", "filesize", "fileurl", "mimetype", "timemodified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModH5pactivityGetH5pactivitiesByCoursesResponseH5pactivitiesInnerDeployedfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModH5pactivityGetH5pactivitiesByCoursesResponseH5pactivitiesInnerDeployedfile from a dict"""
        if obj is None:
            return None
