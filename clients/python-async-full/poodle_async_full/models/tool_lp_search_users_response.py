...
class ToolLpSearchUsersResponse(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictInt] = Field(description="Total number of results.")
    users: List[CoreCompetencyCreatePlanResponseReviewer]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolLpSearchUsersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolLpSearchUsersResponse from a dict"""
        if obj is None:
            return None
