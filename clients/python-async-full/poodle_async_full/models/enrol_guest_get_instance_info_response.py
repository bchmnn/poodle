...
class EnrolGuestGetInstanceInfoResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnrolGuestGetInstanceInfoResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of instanceinfo
        if self.instanceinfo:
            _dict['instanceinfo'] = self.instanceinfo.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnrolGuestGetInstanceInfoResponse from a dict"""
        if obj is None:
            return None
