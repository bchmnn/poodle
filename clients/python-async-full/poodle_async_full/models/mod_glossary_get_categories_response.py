...
class ModGlossaryGetCategoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    categories: List[ModGlossaryGetCategoriesResponseCategoriesInner]
    ...
    __properties: ClassVar[List[str]] = ["categories", "count", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModGlossaryGetCategoriesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModGlossaryGetCategoriesResponse from a dict"""
        if obj is None:
            return None
