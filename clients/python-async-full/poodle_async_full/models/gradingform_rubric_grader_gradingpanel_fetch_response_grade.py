...
class GradingformRubricGraderGradingpanelFetchResponseGrade(BaseModel):
    """
    GradingformRubricGraderGradingpanelFetchResponseGrade
    """ # noqa: E501
    canedit: Optional[StrictBool] = Field(description="Can the user edit this")
    criteria: List[GradingformRubricGraderGradingpanelFetchResponseGradeCriteriaInner]
    ...
    rubricmode: Optional[StrictStr] = Field(description="The mode i.e. evaluate editable")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GradingformRubricGraderGradingpanelFetchResponseGrade from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if rubricmode (nullable) is None
        # and model_fields_set contains the field
        if self.rubricmode is None and "rubricmode" in self.model_fields_set:
            _dict['rubricmode'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GradingformRubricGraderGradingpanelFetchResponseGrade from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "GradingformRubricGraderGradingpanelFetchResponseGrade" in settings.relaxed_models
        ...
        data = {
            ...
            "criteria": [GradingformRubricGraderGradingpanelFetchResponseGradeCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None,
