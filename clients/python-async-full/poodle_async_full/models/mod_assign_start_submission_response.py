...
class ModAssignStartSubmissionResponse(BaseModel):
    """
    ModAssignStartSubmissionResponse
    """ # noqa: E501
    submissionid: Optional[StrictInt] = Field(description="New submission ID.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["submissionid", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModAssignStartSubmissionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModAssignStartSubmissionResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModAssignStartSubmissionResponse" in settings.relaxed_models
