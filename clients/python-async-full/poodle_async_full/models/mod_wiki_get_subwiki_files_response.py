...
class ModWikiGetSubwikiFilesResponse(BaseModel):
    """
    ModWikiGetSubwikiFilesResponse
    """ # noqa: E501
    files: List[CoreBlockGetCourseBlocksResponseBlocksInnerContentsFilesInner] = Field(description="Files")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModWikiGetSubwikiFilesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModWikiGetSubwikiFilesResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModWikiGetSubwikiFilesResponse" in settings.relaxed_models
