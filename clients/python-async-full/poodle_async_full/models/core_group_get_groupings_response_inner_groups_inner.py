...
class CoreGroupGetGroupingsResponseInnerGroupsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["courseid", "customfields", "description", "descriptionformat", "enrolmentkey", "id", "idnumber", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGroupGetGroupingsResponseInnerGroupsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGroupGetGroupingsResponseInnerGroupsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreGroupGetGroupingsResponseInnerGroupsInner" in settings.relaxed_models
