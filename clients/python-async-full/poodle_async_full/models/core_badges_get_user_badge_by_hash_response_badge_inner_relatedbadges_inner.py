...
class CoreBadgesGetUserBadgeByHashResponseBadgeInnerRelatedbadgesInner(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Badge id")
    ...
    __properties: ClassVar[List[str]] = ["id", "language", "name", "type", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreBadgesGetUserBadgeByHashResponseBadgeInnerRelatedbadgesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreBadgesGetUserBadgeByHashResponseBadgeInnerRelatedbadgesInner from a dict"""
        if obj is None:
            return None
