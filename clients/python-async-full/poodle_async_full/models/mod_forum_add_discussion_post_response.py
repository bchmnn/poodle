...
class ModForumAddDiscussionPostResponse(BaseModel):
    ...
    """ # noqa: E501
    messages: Optional[List[ModForumAddDiscussionPostResponseMessagesInner]] = Field(default=None, description="list of warnings")
    post: ModForumAddDiscussionPostResponsePost
    postid: Optional[StrictInt] = Field(description="new post id")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["messages", "post", "postid", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModForumAddDiscussionPostResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if postid (nullable) is None
        # and model_fields_set contains the field
        if self.postid is None and "postid" in self.model_fields_set:
            _dict['postid'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModForumAddDiscussionPostResponse from a dict"""
        if obj is None:
            return None
