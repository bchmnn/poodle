...
class CoreFilesUploadResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["component", "contextid", "filearea", "filename", "filepath", "itemid", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreFilesUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreFilesUploadResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreFilesUploadResponse" in settings.relaxed_models
