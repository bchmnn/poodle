...
class CoreEnrolGetEnrolledUsersWithCapabilityResponseInnerUsersInner(BaseModel):
    ...
    country: Optional[StrictStr] = Field(default=None, description="Country code of the user, such as AU or CZ")
    customfields: Optional[List[CoreEnrolGetEnrolledUsersWithCapabilityResponseInnerUsersInnerCustomfieldsInner]] = Field(default=None, description="User custom fields (also known as user profil fields)")
    ...
    descriptionformat: Optional[StrictInt] = Field(default=None, description="User profile description format")
    ...
    profileimageurl: Optional[StrictStr] = Field(default=None, description="User image profile URL - big")
    profileimageurlsmall: Optional[StrictStr] = Field(default=None, description="User image profile URL - small")
    ...
    __properties: ClassVar[List[str]] = ["address", "city", "country", "customfields", "department", "description", "descriptionformat", "email", "enrolledcourses", "firstaccess", "firstname", "fullname", "groups", "id", "institution", "interests", "lastaccess", "lastcourseaccess", "lastname", "phone1", "phone2", "preferences", "profileimageurl", "profileimageurlsmall", "roles", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreEnrolGetEnrolledUsersWithCapabilityResponseInnerUsersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreEnrolGetEnrolledUsersWithCapabilityResponseInnerUsersInner from a dict"""
        if obj is None:
            return None
        ...
        data = {
            ...
            "customfields": [CoreEnrolGetEnrolledUsersWithCapabilityResponseInnerUsersInnerCustomfieldsInner.from_dict(_item) for _item in obj["customfields"]] if obj.get("customfields") is not None else None,
