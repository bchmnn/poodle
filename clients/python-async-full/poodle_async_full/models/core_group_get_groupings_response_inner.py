...
class CoreGroupGetGroupingsResponseInner(BaseModel):
    """
    ...
    groups: Optional[List[CoreGroupGetGroupingsResponseInnerGroupsInner]] = Field(default=None, description="optional groups")
    ...
    __properties: ClassVar[List[str]] = ["courseid", "customfields", "description", "descriptionformat", "groups", "id", "idnumber", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGroupGetGroupingsResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGroupGetGroupingsResponseInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreGroupGetGroupingsResponseInner" in settings.relaxed_models
        ...
        data = {
            ...
            "groups": [CoreGroupGetGroupingsResponseInnerGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "id": obj.get("id"),
