...
class CoreH5pGetTrustedH5pFileResponse(BaseModel):
    """
    CoreH5pGetTrustedH5pFileResponse
    """ # noqa: E501
    files: List[CoreBlockGetCourseBlocksResponseBlocksInnerContentsFilesInner] = Field(description="H5P file trusted.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["files", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreH5pGetTrustedH5pFileResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreH5pGetTrustedH5pFileResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreH5pGetTrustedH5pFileResponse" in settings.relaxed_models
