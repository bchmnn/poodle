...
class ToolLpDataForCourseCompetenciesPageResponseSettings(BaseModel):
    """
    ...
    pushratingstouserplans: StrictBool = Field(description="pushratingstouserplans")
    ...
    __properties: ClassVar[List[str]] = ["courseid", "id", "pushratingstouserplans", "timecreated", "timemodified", "usermodified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolLpDataForCourseCompetenciesPageResponseSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolLpDataForCourseCompetenciesPageResponseSettings from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ToolLpDataForCourseCompetenciesPageResponseSettings" in settings.relaxed_models
