...
class CoreUserUpdatePictureResponse(BaseModel):
    """
    CoreUserUpdatePictureResponse
    """ # noqa: E501
    profileimageurl: Optional[StrictStr] = Field(default=None, description="New profile user image url")
    success: Optional[StrictBool] = Field(description="True if the image was updated, false otherwise.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["profileimageurl", "success", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreUserUpdatePictureResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreUserUpdatePictureResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreUserUpdatePictureResponse" in settings.relaxed_models
