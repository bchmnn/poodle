...
class ModImscpGetImscpsByCoursesResponseImscpsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "enableaitools", "enabledaiactions", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "keepold", "lang", "name", "revision", "section", "structure", "timemodified", "visible"]
