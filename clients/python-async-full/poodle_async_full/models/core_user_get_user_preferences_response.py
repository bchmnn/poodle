...
class CoreUserGetUserPreferencesResponse(BaseModel):
    ...
    """ # noqa: E501
    preferences: List[CoreUserGetUserPreferencesResponsePreferencesInner] = Field(description="User custom fields (also known as user profile fields)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreUserGetUserPreferencesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreUserGetUserPreferencesResponse from a dict"""
        if obj is None:
            return None
