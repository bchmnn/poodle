...
class ReportInsightsSetNotusefulPredictionResponse(BaseModel):
    """
    ReportInsightsSetNotusefulPredictionResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(description="True if the prediction was successfully flagged as not useful.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["success", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportInsightsSetNotusefulPredictionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportInsightsSetNotusefulPredictionResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ReportInsightsSetNotusefulPredictionResponse" in settings.relaxed_models
