...
class CoreCourseCheckUpdatesResponseInstancesInner(BaseModel):
    ...
    """ # noqa: E501
    contextlevel: Optional[StrictStr] = Field(description="The context level")
    id: Optional[StrictInt] = Field(description="Instance id")
    updates: List[CoreCourseCheckUpdatesResponseInstancesInnerUpdatesInner]
    __properties: ClassVar[List[str]] = ["contextlevel", "id", "updates"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCourseCheckUpdatesResponseInstancesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCourseCheckUpdatesResponseInstancesInner from a dict"""
        if obj is None:
            return None
