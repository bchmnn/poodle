...
class ModLtiGetLtisByCoursesResponseLtisInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "debuglaunch", "enableaitools", "enabledaiactions", "grade", "groupingid", "groupmode", "icon", "id", "instructorchoiceacceptgrades", "instructorchoiceallowroster", "instructorchoiceallowsetting", "instructorchoicesendemailaddr", "instructorchoicesendname", "instructorcustomparameters", "intro", "introfiles", "introformat", "lang", "launchcontainer", "name", "password", "resourcekey", "section", "secureicon", "securetoolurl", "servicesalt", "showdescriptionlaunch", "showtitlelaunch", "timecreated", "timemodified", "toolurl", "typeid", "visible"]
