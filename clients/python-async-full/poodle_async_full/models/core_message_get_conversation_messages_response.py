...
class CoreMessageGetConversationMessagesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "members", "messages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreMessageGetConversationMessagesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreMessageGetConversationMessagesResponse from a dict"""
        if obj is None:
            return None
