...
class CoreGradesGraderGradingpanelPointFetchResponseGrade(BaseModel):
    """
    CoreGradesGraderGradingpanelPointFetchResponseGrade
    """ # noqa: E501
    grade: Optional[Union[StrictFloat, StrictInt]] = Field(description="The numeric grade")
    ...
    __properties: ClassVar[List[str]] = ["grade", "gradedby", "maxgrade", "timecreated", "timemodified", "usergrade"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGradesGraderGradingpanelPointFetchResponseGrade from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGradesGraderGradingpanelPointFetchResponseGrade from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreGradesGraderGradingpanelPointFetchResponseGrade" in settings.relaxed_models
