...
class CoreCompetencyListCourseModuleCompetenciesResponseInner(BaseModel):
    ...
    coursemodulecompetency: CoreCompetencyListCourseModuleCompetenciesResponseInnerCoursemodulecompetency
    __properties: ClassVar[List[str]] = ["competency", "coursemodulecompetency"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCourseModuleCompetenciesResponseInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of coursemodulecompetency
        if self.coursemodulecompetency:
            _dict['coursemodulecompetency'] = self.coursemodulecompetency.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCourseModuleCompetenciesResponseInner from a dict"""
        if obj is None:
            return None
