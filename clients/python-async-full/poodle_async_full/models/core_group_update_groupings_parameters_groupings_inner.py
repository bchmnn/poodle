...
class CoreGroupUpdateGroupingsParametersGroupingsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(description="id of grouping")
    ...
    __properties: ClassVar[List[str]] = ["customfields", "description", "descriptionformat", "id", "idnumber", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGroupUpdateGroupingsParametersGroupingsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGroupUpdateGroupingsParametersGroupingsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreGroupUpdateGroupingsParametersGroupingsInner" in settings.relaxed_models
