...
class ToolLpDataForPlanPageResponseCompetenciesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["competency", "comppath", "usercompetency", "usercompetencyplan"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolLpDataForPlanPageResponseCompetenciesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolLpDataForPlanPageResponseCompetenciesInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ToolLpDataForPlanPageResponseCompetenciesInner" in settings.relaxed_models
