...
class CoreTagUpdateTagsParametersTagsInner(BaseModel):
    """
    CoreTagUpdateTagsParametersTagsInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="tag description")
    descriptionformat: Optional[StrictInt] = Field(default=None, description="tag description format")
    ...
    official: Optional[StrictInt] = Field(default=None, description="(deprecated, use isstandard) whether this flag is standard")
    rawname: Optional[StrictStr] = Field(default=None, description="tag raw name (may contain capital letters)")
    __properties: ClassVar[List[str]] = ["description", "descriptionformat", "flag", "id", "isstandard", "official", "rawname"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreTagUpdateTagsParametersTagsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreTagUpdateTagsParametersTagsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreTagUpdateTagsParametersTagsInner" in settings.relaxed_models
