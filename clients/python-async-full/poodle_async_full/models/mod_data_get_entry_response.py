...
class ModDataGetEntryResponse(BaseModel):
    """
    ModDataGetEntryResponse
    """ # noqa: E501
    entry: ModDataGetEntriesResponseEntriesInner
    entryviewcontents: Optional[StrictStr] = Field(default=None, description="The entry as is rendered in the site.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModDataGetEntryResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if entryviewcontents (nullable) is None
        # and model_fields_set contains the field
        if self.entryviewcontents is None and "entryviewcontents" in self.model_fields_set:
            _dict['entryviewcontents'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModDataGetEntryResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModDataGetEntryResponse" in settings.relaxed_models

        if not isinstance(obj, dict):
            return cls.model_construct(**obj) if relaxed else cls.model_validate(obj)

        data = {
            "entry": ModDataGetEntriesResponseEntriesInner.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
            "entryviewcontents": obj.get("entryviewcontents"),
