...
class CoreCourseSearchCoursesResponse(BaseModel):
    ...
    """ # noqa: E501
    courses: List[CoreCourseSearchCoursesResponseCoursesInner] = Field(description="course")
    total: Optional[StrictInt] = Field(description="total course count")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["courses", "total", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCourseSearchCoursesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCourseSearchCoursesResponse from a dict"""
        if obj is None:
            return None
