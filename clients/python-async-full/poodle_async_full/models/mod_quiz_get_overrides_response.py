...
class ModQuizGetOverridesResponse(BaseModel):
    ...
    """ # noqa: E501
    overrides: List[ModQuizGetOverridesResponseOverridesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModQuizGetOverridesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModQuizGetOverridesResponse from a dict"""
        if obj is None:
            return None
