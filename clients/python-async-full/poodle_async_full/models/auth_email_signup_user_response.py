...
class AuthEmailSignupUserResponse(BaseModel):
    """
    AuthEmailSignupUserResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(description="True if the user was created false otherwise")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthEmailSignupUserResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthEmailSignupUserResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "AuthEmailSignupUserResponse" in settings.relaxed_models
