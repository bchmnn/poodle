...
class ModAssignGetUserMappingsResponse(BaseModel):
    ...
    """ # noqa: E501
    assignments: List[ModAssignGetUserMappingsResponseAssignmentsInner] = Field(description="list of assign user mapping data")
    warnings: Optional[List[ModAssignGetUserMappingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModAssignGetUserMappingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModAssignGetUserMappingsResponse from a dict"""
        if obj is None:
            return None
