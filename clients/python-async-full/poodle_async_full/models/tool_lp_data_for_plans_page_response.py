...
class ToolLpDataForPlansPageResponse(BaseModel):
    ...
    """ # noqa: E501
    canmanageuserplans: Optional[StrictBool] = Field(description="Can the current user manage the user's plans")
    canreaduserevidence: Optional[StrictBool] = Field(description="Can the current user view the user's evidence")
    ...
    userid: Optional[StrictInt] = Field(description="The learning plan user id")
    __properties: ClassVar[List[str]] = ["canmanageuserplans", "canreaduserevidence", "navigation", "plans", "pluginbaseurl", "userid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolLpDataForPlansPageResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.plans:
            ...
            _dict['plans'] = _items
        # set to None if canmanageuserplans (nullable) is None
        # and model_fields_set contains the field
        if self.canmanageuserplans is None and "canmanageuserplans" in self.model_fields_set:
            _dict['canmanageuserplans'] = None

        # set to None if canreaduserevidence (nullable) is None
        # and model_fields_set contains the field
        if self.canreaduserevidence is None and "canreaduserevidence" in self.model_fields_set:
            _dict['canreaduserevidence'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolLpDataForPlansPageResponse from a dict"""
        if obj is None:
            return None
