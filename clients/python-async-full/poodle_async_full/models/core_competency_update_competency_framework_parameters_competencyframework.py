...
class CoreCompetencyUpdateCompetencyFrameworkParametersCompetencyframework(BaseModel):
    """
    ...
    scaleconfiguration: Optional[StrictStr] = Field(default='', description="scaleconfiguration")
    scaleid: Optional[StrictInt] = Field(default=0, description="scaleid")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyUpdateCompetencyFrameworkParametersCompetencyframework from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyUpdateCompetencyFrameworkParametersCompetencyframework from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreCompetencyUpdateCompetencyFrameworkParametersCompetencyframework" in settings.relaxed_models
