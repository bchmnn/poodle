...
class CoreEnrolGetPotentialUsersResponseInnerCustomfieldsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreEnrolGetPotentialUsersResponseInnerCustomfieldsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreEnrolGetPotentialUsersResponseInnerCustomfieldsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreEnrolGetPotentialUsersResponseInnerCustomfieldsInner" in settings.relaxed_models
