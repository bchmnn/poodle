...
class ModUrlGetUrlsByCoursesResponseUrlsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "display", "displayoptions", "externalurl", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "parameters", "section", "timemodified", "visible"]
