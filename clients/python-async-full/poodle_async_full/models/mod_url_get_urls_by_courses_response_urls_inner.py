...
class ModUrlGetUrlsByCoursesResponseUrlsInner(BaseModel):
    """
    ...
    display: Optional[StrictInt] = Field(description="How to display the url")
    ...
    externalurl: Optional[StrictStr] = Field(description="External URL")
    ...
    parameters: Optional[StrictStr] = Field(description="Parameters to append to the URL")
    section: Optional[StrictInt] = Field(default=None, description="Course section id")
    timemodified: Optional[StrictInt] = Field(description="Last time the url was modified")
    visible: Optional[StrictBool] = Field(default=None, description="Visible")
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "display", "displayoptions", "enableaitools", "enabledaiactions", "externalurl", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "parameters", "section", "timemodified", "visible"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModUrlGetUrlsByCoursesResponseUrlsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if externalurl (nullable) is None
        # and model_fields_set contains the field
        if self.externalurl is None and "externalurl" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModUrlGetUrlsByCoursesResponseUrlsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModUrlGetUrlsByCoursesResponseUrlsInner" in settings.relaxed_models
