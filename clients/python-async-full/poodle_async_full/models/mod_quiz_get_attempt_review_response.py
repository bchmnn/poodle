...
class ModQuizGetAttemptReviewResponse(BaseModel):
    ...
    """ # noqa: E501
    additionaldata: List[ModQuizGetAttemptReviewResponseAdditionaldataInner]
    attempt: ModQuizGetAttemptDataResponseAttempt
    grade: Optional[StrictStr] = Field(description="grade for the quiz (or empty or \"notyetgraded\")")
    ...
    __properties: ClassVar[List[str]] = ["additionaldata", "attempt", "grade", "questions", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModQuizGetAttemptReviewResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in additionaldata (list)
        _items = []
        if self.additionaldata:
            for _item_additionaldata in self.additionaldata:
                if _item_additionaldata:
                    _items.append(_item_additionaldata.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModQuizGetAttemptReviewResponse from a dict"""
        if obj is None:
            return None
