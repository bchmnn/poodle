...
class CoreGroupGetCourseGroupsResponseInner(BaseModel):
    """
    CoreGroupGetCourseGroupsResponseInner
    """ # noqa: E501
    courseid: Optional[StrictInt] = Field(description="id of course")
    description: Optional[StrictStr] = Field(description="group description text")
    descriptionformat: Optional[StrictInt] = Field(description="description format (1 = HTML, 0 = MOODLE, 2 = PLAIN, or 4 = MARKDOWN)")
    enrolmentkey: Optional[StrictStr] = Field(description="group enrol secret phrase")
    id: Optional[StrictInt] = Field(description="group record id")
    idnumber: Optional[StrictStr] = Field(description="id number")
    name: Optional[StrictStr] = Field(description="group name")
    participation: Optional[StrictBool] = Field(description="participation mode")
    visibility: Optional[StrictInt] = Field(description="group visibility mode. 0 = Visible to all. 1 = Visible to members. 2 = See own membership. 3 = Membership is hidden.")
    __properties: ClassVar[List[str]] = ["courseid", "description", "descriptionformat", "enrolmentkey", "id", "idnumber", "name", "participation", "visibility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGroupGetCourseGroupsResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGroupGetCourseGroupsResponseInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreGroupGetCourseGroupsResponseInner" in settings.relaxed_models
