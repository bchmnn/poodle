...
class ModPageGetPagesByCoursesResponsePagesInner(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(description="Page content")
    ...
    display: Optional[StrictInt] = Field(description="How to display the page")
    ...
    timemodified: Optional[StrictInt] = Field(description="Last time the page was modified")
    visible: Optional[StrictBool] = Field(default=None, description="Visible")
    __properties: ClassVar[List[str]] = ["content", "contentfiles", "contentformat", "course", "coursemodule", "display", "displayoptions", "enableaitools", "enabledaiactions", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "legacyfiles", "legacyfileslast", "name", "revision", "section", "timemodified", "visible"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModPageGetPagesByCoursesResponsePagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModPageGetPagesByCoursesResponsePagesInner from a dict"""
        if obj is None:
            return None
