...
class CoreCompetencyListCourseCompetenciesResponseInnerCoursecompetency(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["competencyid", "courseid", "id", "ruleoutcome", "sortorder", "timecreated", "timemodified", "usermodified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCourseCompetenciesResponseInnerCoursecompetency from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyListCourseCompetenciesResponseInnerCoursecompetency from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreCompetencyListCourseCompetenciesResponseInnerCoursecompetency" in settings.relaxed_models
