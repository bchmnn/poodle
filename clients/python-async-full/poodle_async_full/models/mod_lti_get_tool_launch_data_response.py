...
class ModLtiGetToolLaunchDataResponse(BaseModel):
    ...
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(description="Endpoint URL")
    parameters: List[ModLtiGetToolLaunchDataResponseParametersInner]
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["endpoint", "parameters", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModLtiGetToolLaunchDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModLtiGetToolLaunchDataResponse from a dict"""
        if obj is None:
            return None
