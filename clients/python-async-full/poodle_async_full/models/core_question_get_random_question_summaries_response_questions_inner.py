...
class CoreQuestionGetRandomQuestionSummariesResponseQuestionsInner(BaseModel):
    ...
    """ # noqa: E501
    category: StrictInt = Field(description="category")
    icon: CoreQuestionGetRandomQuestionSummariesResponseQuestionsInnerIcon
    id: StrictInt = Field(description="id")
    name: StrictStr = Field(description="name")
    parent: StrictInt = Field(description="parent")
    qtype: StrictStr = Field(description="qtype")
    __properties: ClassVar[List[str]] = ["category", "icon", "id", "name", "parent", "qtype"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreQuestionGetRandomQuestionSummariesResponseQuestionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreQuestionGetRandomQuestionSummariesResponseQuestionsInner from a dict"""
        if obj is None:
            return None
