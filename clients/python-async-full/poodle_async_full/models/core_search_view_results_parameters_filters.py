...
class CoreSearchViewResultsParametersFilters(BaseModel):
    """
    filters to apply
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["areaids", "courseids", "timeend", "timestart", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreSearchViewResultsParametersFilters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreSearchViewResultsParametersFilters from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreSearchViewResultsParametersFilters" in settings.relaxed_models
