...
class CoreFilesGetFilesResponseParentsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["component", "contextid", "filearea", "filename", "filepath", "itemid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreFilesGetFilesResponseParentsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreFilesGetFilesResponseParentsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreFilesGetFilesResponseParentsInner" in settings.relaxed_models
