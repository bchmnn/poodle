...
class CoreGradingGetDefinitionsResponseAreasInnerDefinitionsInnerGuideGuideCommentsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "descriptionformat", "id", "sortorder"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreGradingGetDefinitionsResponseAreasInnerDefinitionsInnerGuideGuideCommentsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreGradingGetDefinitionsResponseAreasInnerDefinitionsInnerGuideGuideCommentsInner from a dict"""
        if obj is None:
            return None
