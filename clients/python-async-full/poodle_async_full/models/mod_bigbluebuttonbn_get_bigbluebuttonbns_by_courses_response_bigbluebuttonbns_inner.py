...
class ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesResponseBigbluebuttonbnsInner(BaseModel):
    """
    ...
    timemodified: Optional[StrictInt] = Field(description="Last time the instance was modified")
    visible: Optional[StrictBool] = Field(default=None, description="Visible")
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "enableaitools", "enabledaiactions", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "meetingid", "name", "section", "timemodified", "visible"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesResponseBigbluebuttonbnsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesResponseBigbluebuttonbnsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModBigbluebuttonbnGetBigbluebuttonbnsByCoursesResponseBigbluebuttonbnsInner" in settings.relaxed_models
