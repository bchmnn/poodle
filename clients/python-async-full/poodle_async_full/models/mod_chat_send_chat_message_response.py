...
class ModChatSendChatMessageResponse(BaseModel):
    """
    ModChatSendChatMessageResponse
    """ # noqa: E501
    messageid: Optional[StrictInt] = Field(description="message sent id")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModChatSendChatMessageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModChatSendChatMessageResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModChatSendChatMessageResponse" in settings.relaxed_models
