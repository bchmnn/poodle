...
class ReportInsightsSetFixedPredictionResponse(BaseModel):
    """
    ReportInsightsSetFixedPredictionResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(description="True if the prediction was successfully flagged as fixed.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportInsightsSetFixedPredictionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportInsightsSetFixedPredictionResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ReportInsightsSetFixedPredictionResponse" in settings.relaxed_models
