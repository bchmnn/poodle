...
class ModBookGetBooksByCoursesResponseBooksInner(BaseModel):
    ...
    customtitles: Optional[StrictInt] = Field(description="Book custom titles type")
    ...
    navstyle: Optional[StrictInt] = Field(description="Book navigation style configuration")
    numbering: Optional[StrictInt] = Field(description="Book numbering configuration")
    revision: Optional[StrictInt] = Field(default=None, description="Book revision")
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "customtitles", "enableaitools", "enabledaiactions", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "navstyle", "numbering", "revision", "section", "timecreated", "timemodified", "visible"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModBookGetBooksByCoursesResponseBooksInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if customtitles (nullable) is None
        # and model_fields_set contains the field
        if self.customtitles is None and "customtitles" in self.model_fields_set:
            _dict['customtitles'] = None
        ...
        # set to None if navstyle (nullable) is None
        # and model_fields_set contains the field
        if self.navstyle is None and "navstyle" in self.model_fields_set:
            _dict['navstyle'] = None

        # set to None if numbering (nullable) is None
        # and model_fields_set contains the field
        if self.numbering is None and "numbering" in self.model_fields_set:
            _dict['numbering'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModBookGetBooksByCoursesResponseBooksInner from a dict"""
        if obj is None:
            return None
        ...
        data = {
            ...
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "navstyle": obj.get("navstyle"),
            "numbering": obj.get("numbering"),
