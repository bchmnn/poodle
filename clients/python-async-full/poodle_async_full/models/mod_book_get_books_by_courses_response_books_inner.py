...
class ModBookGetBooksByCoursesResponseBooksInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["course", "coursemodule", "customtitles", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "name", "navstyle", "numbering", "revision", "section", "timecreated", "timemodified", "visible"]
