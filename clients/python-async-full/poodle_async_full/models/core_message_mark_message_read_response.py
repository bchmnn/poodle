...
class CoreMessageMarkMessageReadResponse(BaseModel):
    """
    CoreMessageMarkMessageReadResponse
    """ # noqa: E501
    messageid: Optional[StrictInt] = Field(description="the id of the message in the messages table")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["messageid", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreMessageMarkMessageReadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreMessageMarkMessageReadResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreMessageMarkMessageReadResponse" in settings.relaxed_models
