...
class CoreReportbuilderRetrieveReportResponse(BaseModel):
    ...
    """ # noqa: E501
    data: CoreReportbuilderRetrieveReportResponseData
    details: CoreReportbuilderListReportsResponseReportsInner
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["data", "details", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreReportbuilderRetrieveReportResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreReportbuilderRetrieveReportResponse from a dict"""
        if obj is None:
            return None
