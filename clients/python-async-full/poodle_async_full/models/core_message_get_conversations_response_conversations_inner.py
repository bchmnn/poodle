...
class CoreMessageGetConversationsResponseConversationsInner(BaseModel):
    """
    ...
    cansendmessagetoconversation: Optional[StrictBool] = Field(default=True, description="If the user can send messages in the conversation")
    ...
    __properties: ClassVar[List[str]] = ["candeletemessagesforallusers", "cansendmessagetoconversation", "id", "imageurl", "isfavourite", "ismuted", "isread", "membercount", "members", "messages", "name", "subname", "type", "unreadcount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreMessageGetConversationsResponseConversationsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cansendmessagetoconversation (nullable) is None
        # and model_fields_set contains the field
        if self.cansendmessagetoconversation is None and "cansendmessagetoconversation" in self.model_fields_set:
            _dict['cansendmessagetoconversation'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreMessageGetConversationsResponseConversationsInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreMessageGetConversationsResponseConversationsInner" in settings.relaxed_models
        ...
        data = {
            ...
            "cansendmessagetoconversation": obj.get("cansendmessagetoconversation") if obj.get("cansendmessagetoconversation") is not None else True,
            "id": obj.get("id"),
