...
class ModForumCanAddDiscussionResponse(BaseModel):
    """
    ModForumCanAddDiscussionResponse
    """ # noqa: E501
    cancreateattachment: Optional[StrictBool] = Field(default=None, description="True if the user can add attachments, false otherwise.")
    canpindiscussions: Optional[StrictBool] = Field(default=None, description="True if the user can pin discussions, false otherwise.")
    status: Optional[StrictBool] = Field(description="True if the user can add discussions, false otherwise.")
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["cancreateattachment", "canpindiscussions", "status", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModForumCanAddDiscussionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModForumCanAddDiscussionResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModForumCanAddDiscussionResponse" in settings.relaxed_models
