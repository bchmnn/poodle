...
class CoreOutputLoadTemplateWithDependenciesResponse(BaseModel):
    ...
    """ # noqa: E501
    strings: List[CoreOutputLoadTemplateWithDependenciesResponseStringsInner]
    templates: List[CoreOutputLoadTemplateWithDependenciesResponseStringsInner]
    __properties: ClassVar[List[str]] = ["strings", "templates"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreOutputLoadTemplateWithDependenciesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreOutputLoadTemplateWithDependenciesResponse from a dict"""
        if obj is None:
            return None
