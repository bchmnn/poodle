...
class ModResourceGetResourcesByCoursesResponse(BaseModel):
    ...
    """ # noqa: E501
    resources: List[ModResourceGetResourcesByCoursesResponseResourcesInner]
    warnings: Optional[List[AuthEmailGetSignupSettingsResponseWarningsInner]] = Field(default=None, description="list of warnings")
    __properties: ClassVar[List[str]] = ["resources", "warnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModResourceGetResourcesByCoursesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModResourceGetResourcesByCoursesResponse from a dict"""
        if obj is None:
            return None
