...
class ModDataGetDatabasesByCoursesResponse(BaseModel):
    ...
    """ # noqa: E501
    databases: List[ModDataGetDatabasesByCoursesResponseDatabasesInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModDataGetDatabasesByCoursesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModDataGetDatabasesByCoursesResponse from a dict"""
        if obj is None:
            return None
