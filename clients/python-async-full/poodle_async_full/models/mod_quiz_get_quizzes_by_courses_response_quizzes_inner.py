...
class ModQuizGetQuizzesByCoursesResponseQuizzesInner(BaseModel):
    ...
    precreateattempts: Optional[StrictInt] = Field(default=None, description="Whether attempt pre-creation is enabled")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if precreateattempts (nullable) is None
        # and model_fields_set contains the field
        if self.precreateattempts is None and "precreateattempts" in self.model_fields_set:
            _dict['precreateattempts'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        data = {
            ...
            "precreateattempts": obj.get("precreateattempts"),
