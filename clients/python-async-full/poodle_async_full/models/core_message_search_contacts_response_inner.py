...
class CoreMessageSearchContactsResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fullname", "id", "profileimageurl", "profileimageurlsmall"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreMessageSearchContactsResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreMessageSearchContactsResponseInner from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreMessageSearchContactsResponseInner" in settings.relaxed_models
