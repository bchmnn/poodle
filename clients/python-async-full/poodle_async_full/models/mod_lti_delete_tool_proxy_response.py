...
class ModLtiDeleteToolProxyResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModLtiDeleteToolProxyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModLtiDeleteToolProxyResponse from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "ModLtiDeleteToolProxyResponse" in settings.relaxed_models
