...
class CoreMessageDataForMessageareaSearchMessagesResponse(BaseModel):
    ...
    """ # noqa: E501
    contacts: List[CoreMessageDataForMessageareaSearchMessagesResponseContactsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreMessageDataForMessageareaSearchMessagesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreMessageDataForMessageareaSearchMessagesResponse from a dict"""
        if obj is None:
            return None
