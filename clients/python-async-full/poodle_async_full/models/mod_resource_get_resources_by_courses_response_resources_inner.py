...
class ModResourceGetResourcesByCoursesResponseResourcesInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentfiles", "course", "coursemodule", "display", "displayoptions", "enableaitools", "enabledaiactions", "filterfiles", "groupingid", "groupmode", "id", "intro", "introfiles", "introformat", "lang", "legacyfiles", "legacyfileslast", "name", "revision", "section", "timemodified", "tobemigrated", "visible"]
