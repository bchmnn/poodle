...
class CoreCompetencyCreatePlanParametersPlan(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "descriptionformat", "duedate", "name", "origtemplateid", "reviewerid", "status", "templateid", "timecreated", "timemodified", "userid", "usermodified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCompetencyCreatePlanParametersPlan from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCompetencyCreatePlanParametersPlan from a dict"""
        if obj is None:
            return None

        relaxed = settings.relaxe_all_models or "CoreCompetencyCreatePlanParametersPlan" in settings.relaxed_models
