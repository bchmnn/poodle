...
class CoreMessageSendInstantMessagesResponseInner(BaseModel):
    ...
    cantsendtouser: Optional[StrictStr] = Field(default=None, description="The user that could not be sent to")
    ...
    __properties: ClassVar[List[str]] = ["candeletemessagesforallusers", "cantsendtouser", "clientmsgid", "conversationid", "errormessage", "msgid", "text", "timecreated", "useridfrom"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cantsendtouser (nullable) is None
        # and model_fields_set contains the field
        if self.cantsendtouser is None and "cantsendtouser" in self.model_fields_set:
            _dict['cantsendtouser'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        data = {
            ...
            "cantsendtouser": obj.get("cantsendtouser"),
