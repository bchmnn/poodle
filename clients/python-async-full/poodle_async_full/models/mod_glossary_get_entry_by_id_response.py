...
class ModGlossaryGetEntryByIdResponse(BaseModel):
    ...
    """ # noqa: E501
    entry: ModGlossaryGetEntriesByAuthorIdResponseEntriesInner
    permissions: Optional[ModGlossaryGetEntryByIdResponsePermissions] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModGlossaryGetEntryByIdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModGlossaryGetEntryByIdResponse from a dict"""
        if obj is None:
            return None
