...
class ModAssignGetUserFlagsResponseAssignmentsInnerUserflagsInner(BaseModel):
    ...
    """ # noqa: E501
    allocatedmarker: Optional[StrictInt] = Field(description="allocated marker")
    extensionduedate: Optional[StrictInt] = Field(description="extension due date")
    id: Optional[StrictInt] = Field(description="user flag id")
    locked: Optional[StrictInt] = Field(description="locked")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModAssignGetUserFlagsResponseAssignmentsInnerUserflagsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModAssignGetUserFlagsResponseAssignmentsInnerUserflagsInner from a dict"""
        if obj is None:
            return None
