...
class ModAssignGetSubmissionsResponseAssignmentsInnerSubmissionsInner(BaseModel):
    ...
    plugins: Optional[List[ModAssignGetSubmissionsResponseAssignmentsInnerSubmissionsInnerPluginsInner]] = Field(default=None, description="plugins")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModAssignGetSubmissionsResponseAssignmentsInnerSubmissionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModAssignGetSubmissionsResponseAssignmentsInnerSubmissionsInner from a dict"""
        if obj is None:
            return None
        ...
        data = {
            ...
            "plugins": [ModAssignGetSubmissionsResponseAssignmentsInnerSubmissionsInnerPluginsInner.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,
