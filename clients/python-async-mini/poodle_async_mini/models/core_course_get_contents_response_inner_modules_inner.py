...
class CoreCourseGetContentsResponseInnerModulesInner(BaseModel):
    ...
    candisplay: Optional[StrictBool] = Field(default=None, description="Whether the module should be displayed on the course page")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if candisplay (nullable) is None
        # and model_fields_set contains the field
        if self.candisplay is None and "candisplay" in self.model_fields_set:
            _dict['candisplay'] = None
