...
class CoreUserGetCourseUserProfilesResponseInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        data = {
            ...
            "email": obj.get("email"),
            "enrolledcourses": [CoreUserGetCourseUserProfilesResponseInnerEnrolledcoursesInner.from_dict(_item) for _item in obj["enrolledcourses"]] if obj.get("enrolledcourses") is not None else None,
